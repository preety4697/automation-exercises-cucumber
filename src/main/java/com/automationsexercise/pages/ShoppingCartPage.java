package com.automationsexercise.pages;

import com.automationsexercise.utility.Utility;
...
public class ShoppingCartPage extends Utility {
    ...
    public void clickOnCrossButtonAcrossProductToRemove(){
        log.info("Clicking on cross button on across product to remove : " + crossButtonAcrossProductToRemove.toString());
