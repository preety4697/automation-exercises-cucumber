package com.automationsexercise.steps;

import com.automationsexercise.pages.HomePage;
import com.automationsexercise.pages.LoginPage;
...
public class LoginSteps {
    ...
    public void iShouldSeeTheText(String text) {
        String uname =PropertyReader.getInstance().getProperty("userName");

        if (uname == null || uname.equals("null"))
        {
            uname = "";
        }
        Assert.assertEquals(new HomePage().getLoggedInAsUserNameText(), text + uname);
    }
